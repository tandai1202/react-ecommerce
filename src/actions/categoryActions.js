...
export const getCategoriesList = async(dispatch) => {
    ...
    try {
        ...
        dispatch({ type: actionType.CATEGORY_LIST_FAIL, payload: error.message });
    }
}
...
export const getCategoryProducts = async(dispatch, categoryKey) => {
    ...
    try {
        ...
        dispatch({ type: actionType.CATEGORY_PRODUCT_SUCCESS, payload: data.products });
    } catch (error) {
        dispatch({ type: actionType.CATEGORY_PRODUCT_FAIL, payload: error.message });
    }
}